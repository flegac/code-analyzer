...
import { PP } from "../physics/physics.service.js";
const STYLE = `
  .panel {
    display: flex;
...
export class PhysicsComponent extends BaseComponent {
    ...
    updateGui() {
        ...
        if (relationEl)
            relationEl.value = s.link.relationStrengthFactor;
    }
}
