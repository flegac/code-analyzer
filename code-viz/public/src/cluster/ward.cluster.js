...
export class WardClusterStrategy extends ClusterStrategy {
    constructor(graph, clusterNumber = 5, k = 10) {
        super();
        ...
        this.groupById = {};
        partition.forEach((group, groupId) => {
...
export class WardClustering2 {
    constructor(nodes, targetClusterCount = 5, k = 10) {
    ...
    _computeInterClusterEdges(c1, c2) {
        let edges = 0;
        for (const n1 of c1) {
...
export class WardClustering {
    constructor(graph, targetClusterCount = 5, k = 10) {
