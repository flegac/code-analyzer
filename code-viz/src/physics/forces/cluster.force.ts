import { CC } from "../../cluster/cluster.service.js";
...
export function clusterForce() {
    ...
    function force(alpha: number) {
        try {
            // console.log(`[cluster] cluster with strategy`, CC.collapseStrategy);
...
function applyGroupForces(group: MyNode[], alpha: number) {
...
function getNodePairs(group: MyNode[]) {
    const pairs = [];
