export class TreeComponent {
   ...
   */
  constructor(options: { renderLeaf?: HTMLElement, renderGroup?: HTMLElement, buildAncestorsMap?: any } = {}) {
  ...
  renderTo(container: HTMLElement, treeData, ctx) {
