...
import { FeatureMaps } from "./project.service.js";


export class Project {
    project: string;
    private _relation: GraphModel;
    private _nodes: FeatureMaps;
    numerics: string[];
    categories: string[];
    labels: string[];
    filters: { selected: any; excluded: any; groups: any; };
    private _config: Config;
    constructor(project = 'test-project', relation: GraphModel, nodes: FeatureMaps = {}, config: Config = {}) {
    ...
    hierarchy() {
        ...
        return graph ? GraphModel.hierarchy(graph) : null;
    }

    read(label: string, id: string) {
