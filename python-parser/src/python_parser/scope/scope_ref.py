...
from python_parser.scope.class_ref import ClassId, ClassRef
from python_parser.scope.method_ref import MethodId, MethodRef
from python_parser.scope.module_ref import ModuleId, ModuleRef
