...
from python_parser.analyzer import analyze_project
from python_parser.dependencies.class_dependency_ts_analyzer import ClassDependencyTsAnalyzer
from python_parser.dependencies.dependency_cst_analyzer import DependencyCstAnalyzer
from python_parser.dependencies.dependency_ts_analyzer import DependencyTsAnalyzer
...
projects = {
    ...
    'code-analyzer': "/home/flo/Documents/workspace/code-analyzer/python-parser/src",
}

if __name__ == "__main__":
    name = 'organism'
    project_root = Path(projects[name])
    target = Path(__file__).parent.parent.parent.parent / f'resources/projects/{name}'
